...
public class LocalizedNamesImpl_te extends LocalizedNamesImpl {
  ...
  protected void loadNameMapJava() {
    ...
    namesMap.put("IT", "ఇటలీ");
    namesMap.put("JE", "జెర్సీ");
    namesMap.put("JM", "జమైకా");
    namesMap.put("JO", "జోర్డాన్");
    namesMap.put("JP", "జపాన్");
    namesMap.put("KE", "కెన్యా");
    namesMap.put("KG", "కిర్గిజిస్తాన్");
    ...
    namesMap.put("ZZ", "తెలియని ప్రాంతం");
  }
